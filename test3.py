...
while True:
    you = input("Bạn: ")  # Nhập câu hỏi thay vì sử dụng giọng nói
    
    robot_brain = ""

    # Phản hồi dựa trên đầu vào của người dùng
    if you.strip() == "":
